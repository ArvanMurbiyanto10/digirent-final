<x-app-layout>
    ...
    {{-- CSS TAMBAHAN UNTUK ANIMASI & ELEMEN BARU (Tetap Sama) --}}
    <style>
    ...
    {{-- Fitur Notifikasi Animasi (Tetap Sama) --}}
    ...
    <div class="relative bg-white overflow-hidden">
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">Sewa Gadget</span>
                            <span class="block text-indigo-600 xl:inline">Impianmu di Sini</span>
                        </h1>
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Handphone, Laptop terbaru siap menemanimu. Temukan gadget impianmu dengan mudah, cepat, dan aman di DigiRent.
                        </p>
                        {{-- Tombol CTA --}}
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-md shadow">
                                {{-- Tombol "Lihat Katalog" diubah ke warna ungu --}}
                                <a href="{{ route('products.index') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 md:py-4 md:text-lg md:px-10">
                                    Lihat Katalog
                                </a>
                            </div>
                        </div>
        ...
        {{-- Bagian Gambar Utama di Kanan (URL SUDAH DIGANTI) --}}
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
                 src="https://png.pngtree.com/thumb_back/fw800/background/20220427/pngtree-used-gadgets-sale-gadget-exchange-image_1091441.jpg"
                 alt="Sewa Gadget Laptop dan Kamera">
        </div>
    </div>
    {{-- ============================================= --}}
    {{-- == [AKHIR DARI HERO SECTION BARU] == --}}
    {{-- ============================================= --}}
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="relative w-full overflow-hidden mb-8">
                <div class="animate-marquee-left">
                    <div class="marquee-group">
                        {{-- SEMUA SRC DIBAWAH INI TELAH DIPERBAIKI --}}
                        <div class="brand-box brand-apple mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/apple-logo.jpeg') }}" alt="Apple" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-samsung mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/samsung-logo.jpeg') }}" alt="Samsung" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-xiaomi mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/Xiaomi-Logo.jpeg') }}" alt="Xiaomi" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-oppo mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/oppo-logo.jpeg') }}" alt="Oppo" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-vivo mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/vivo-logo.jpeg') }}" alt="Vivo" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-asus mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/asus-logo.jpeg') }}" alt="Asus" class="max-h-full max-w-full object-contain"> </div>
                    </div>
            ...
            <div class="relative w-full overflow-hidden">
                <div class="animate-marquee-right">
                    <div class="marquee-group">
                        {{-- SEMUA SRC DIBAWAH INI TELAH DIPERBAIKI --}}
                        <div class="brand-box brand-gopix mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/gopix-logo.jpeg') }}" alt="Gopix" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-rog mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/rog-logo.jpeg') }}" alt="ROG" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-macbook mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/macbook-logo.jpeg') }}" alt="MacBook" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-xiaomi mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/Xiaomi-Logo.jpeg') }}" alt="Xiaomi" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-samsung mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/samsung-logo.jpeg') }}" alt="Samsung" class="max-h-full max-w-full object-contain"> </div>
                        <div class="brand-box brand-apple mx-4 flex-shrink-0 rounded-lg shadow-md p-4 flex items-center justify-center h-20 w-40 transition hover:shadow-lg"> <img src="{{ asset('storage/logo/apple-logo.jpeg') }}" alt="Apple" class="max-h-full max-w-full object-contain"> </div>
                    </div>
    ...
    {{-- Berita Gadget Terbaru Section (Tetap Sama) --}}
    ...
    {{-- Kenapa Memilih DigiRent Section (Tetap Sama) --}}
