<x-app-layout>
    ...
    {{-- ======================================================== --}}
    {{-- == [PENTING] PANGGIL CSS & JS MANUAL DARI cPANEL == --}}
    {{-- ======================================================== --}}
    {{-- Pastikan file ini ada di public_html/build/assets/ --}}
    ...
    {{-- CSS TAMBAHAN UNTUK ANIMASI & ELEMEN KHUSUS --}}
    <style>
        /* Animasi Marquee */
        ...
        /* ================================================= */
        /* === [BAGIAN CSS LOGO BRAND - PILIHAN 1] === */
        /* ================================================= */
        .brand-box {
            /* Layout & Ukuran */
            display: flex;
        ...
        /* Agar Gambar Logo Rapi di Tengah */
        .brand-box img {
            max-height: 100%;
            max-width: 100%;
            object-fit: contain;
    ...
    {{-- Notifikasi Login Berhasil (Animasi Pojok Kanan Atas) --}}
    ...
    <div class="bg-slate-50 py-16 z-20 overflow-hidden border-t border-slate-100">
        <div class="container mx-auto px-6">
            ...
            <div class="relative w-full overflow-hidden mb-8">
                <div class="animate-marquee-left">
                    <div class="marquee-group">
                        <div class="brand-box"><img src="{{ asset('storage/logo/apple-logo.jpeg') }}" alt="Apple"></div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/samsung-logo.jpeg') }}" alt="Samsung">
                        </div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/Xiaomi-Logo.jpeg') }}" alt="Xiaomi">
                        </div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/oppo-logo.jpeg') }}" alt="Oppo"></div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/vivo-logo.jpeg') }}" alt="Vivo"></div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/asus-logo.jpeg') }}" alt="Asus"></div>
                    </div>
            ...
            <div class="relative w-full overflow-hidden">
                <div class="animate-marquee-right">
                    <div class="marquee-group">
                        <div class="brand-box"><img src="{{ asset('storage/logo/gopix-logo.jpeg') }}" alt="Gopix"></div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/rog-logo.jpeg') }}" alt="ROG"></div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/macbook-logo.jpeg') }}" alt="MacBook">
                        </div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/Xiaomi-Logo.jpeg') }}" alt="Xiaomi">
                        </div>
                        <div class="brand-box"><img src="{{ asset('storage/logo/samsung-logo.jpeg') }}" alt="Samsung">
                ...
                @forelse ($newsItems as $item)
                    <div
                        ...
                        <a href="{{ $item->link_url }}" target="_blank" class="flex h-full">
                            {{-- Menggunakan Storage::url untuk gambar dinamis --}}
    ...
    <div class="py-16 bg-gradient-to-br from-indigo-50 via-purple-50 to-white bg-dots-pattern relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center relative z-10 pt-8">
            <h2 class="text-3xl font-bold text-indigo-700 mb-4">Kenapa Memilih MY cell?</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="p-6 bg-white/50 backdrop-blur-sm rounded-lg shadow-sm hover:shadow-lg transition">
    ...
    {{-- FAQ (Tanya Jawab) --}}
    <div id="faq-section" class="relative py-24 bg-gradient-to-t from-purple-100 via-indigo-50 to-white">
        ...
        <div class="container mx-auto px-6 pt-12">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 mt-3 text-lg">Pertanyaan yang paling sering diajukan seputar MY cell.</p>
            </div>
                ...
                <div class="border-b border-slate-300">
                    ...
                    <div x-show="open === 1" x-collapse x-cloak class="pb-6">
                        <p class="text-slate-600">Untuk menyewa, Anda hanya perlu menyiapkan identitas diri (KTP/SIM)
                            ...
                            mungkin diperlukan jaminan tambahan.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-slate-300">
                    ...
                    <div x-show="open === 3" x-collapse x-cloak class="pb-6">
                        <p class="text-slate-600">Tentu saja! Anda bisa mengajukan perpanjangan sewa melalui dashboard
                            ...
                            tersebut belum dipesan oleh orang lain.</p>
                    </div>
                </div>
